...
{
    //Tempos
    clock_t tInicio, tFim, tTempoTotal, tDecorrido;
    ...
    cout << "Tempo inicio: " << tInicio << "\n";
    cout << "Tempo fim: " << tFim << "\n";

    tTempoTotal = tFim - tInicio;
	tDecorrido = ( (double) (tFim - tInicio) ) / CLOCKS_PER_SEC;

    cout << "Tempo total em milissegundos: " << tTempoTotal << "\n";
	cout << "Tempo decorrido em segundos: " << tDecorrido;
